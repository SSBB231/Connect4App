...
public class TryMM_MAX implements Minmax {
...
//        Random random = new Random();
        ...
        int value = maxValue(stateCopy, Integer.MIN_VALUE, Integer.MAX_VALUE, depth, limit, first);

        if(move == -1) {
            System.out.println("==== P1 MAKES RANDOM MOVE ========");
            move = new Random().nextInt(7);
        }
        else
        {
            System.out.println("------------- P1 Makes Move: " + move + "----------------------");
        }
